...
void main() {
  ...
  final paciente2 = Paciente(
    ...
    estaActivo: true, // Asegúrate de incluir esto
  );
  ...
  String nssParaEliminar =
      "5538230389035"; // Asegúrate de que el NSS sea un String
...
//fecha acctualizacion en defuncion

impklementar override de persona
